...
RIGHT_CLICK_DISTANCE_RATIO = (
    0.22  # Fraction of palm size (Wrist to Middle MCP) for a click
)
...
TOGGLE_ON_STILLNESS_SECONDS = (
    2.0  # Seconds to hold toggle-on gesture steadily before enabling
)


TOGGLE_ON_WIGGLE_RATIO = (
    0.12  # Allowed movement during activation as fraction of palm size
)
...
TOGGLE_ON_DRIFT_FRAMES = (
    3  # Number of consecutive frames outside wiggle before resetting timer
)
...
MIC_TOGGLE_DISTANCE_RATIO = 0.25  # Fraction of palm size for pinch detection


MIC_TOGGLE_COOLDOWN = 2.0  # Seconds to wait between toggles
